 ...
 */
@RestController
@RequestMapping(value = "/api/v1/replies", consumes = {"application/json"}, produces = {"application/json"})
...
public class ReplyManageController {
    ...
    public ResponseEntity<CreateReplyResponseDto> createReply(@Valid @RequestBody CreateReplyRequestDto request) {
        CreateReplyResponseDto response = replyManageService.createReply(request);

        return ResponseEntity.created(URI.create("/api/v1/post/" + request.getPostNo()))
                .body(response);
    }
    ...
    public ResponseEntity<ModifyReplyResponseDto> modifyReply(@Valid @RequestBody ModifyReplyRequestDto request,
        ...
        ModifyReplyResponseDto modifyReplyResponseDto = replyManageService.modifyReply(replyNo, request);
    ...
    public ResponseEntity<Void> safeDeleteByReplyNo(@PathVariable Long replyNo) {
        replyManageService.safeDeleteByReplyNo(replyNo);
