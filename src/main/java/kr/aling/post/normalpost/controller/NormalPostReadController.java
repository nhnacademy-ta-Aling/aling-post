...
public class NormalPostReadController {
     ...
     */
    @GetMapping("/{postNo}")
    public ResponseEntity<ReadPostResponseDto> readNormalPost(@PathVariable Long postNo) {

        ReadPostResponseDto response = normalPostReadService.readNormalPostByPostNo(postNo);
