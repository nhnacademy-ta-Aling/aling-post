package kr.aling.post.common.aspect;

import java.util.Objects;
import javax.servlet.http.HttpServletRequest;
import kr.aling.post.common.enums.BandUserRoleEnum;
...
public class BandAuthAspect {
     ...
     */
    @Around(value = "@annotation(kr.aling.post.common.annotation.BandCreatorAuth)")
     ...
     * @throws Throwable Throwable
     */
    @Around(value = "@annotation(kr.aling.post.common.annotation.BandAdminAuth)")
     ...
     * @throws Throwable Throwable
     */
    @Around(value = "@annotation(kr.aling.post.common.annotation.BandUserAuth)")
