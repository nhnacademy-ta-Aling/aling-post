...
public class LoggingAspect {
    ...
    /**
     * controller 패키지 메서드 실행 전 동작. <br> API 요청에 대한 Method, URI 로깅.
     */
    ...
    /**
     * controller 패키지 메서드 실행 후 동작. <br> API 요청에 대한 URI, 응답 Status 로깅.
     *
    ...
    /**
     * API 응답 중 Exception 발생 후 RestControllerAdvice 에서 처리 시 동작. <br> API 요청에 대한 URI, Status 로깅.
     *
