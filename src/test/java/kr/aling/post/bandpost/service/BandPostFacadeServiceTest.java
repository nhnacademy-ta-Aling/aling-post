...
class BandPostFacadeServiceTest {
    ...
    void bandPost_facade_service_test() {
        ...
        // when
        when(postManageService.createBandPost(any())).thenReturn(createPostResponseDtoTmp);
        ...
        verify(postManageService, times(1)).createBandPost(any(CreateBandPostRequestDto.class));
        verify(postFileManageService, times(1)).savePostFiles(any(Post.class), anyList());
        verify(bandPostManageService, times(1)).createBandPost(any(CreatePostResponseDtoTmp.class),
