...
* [Spring Configuration Processor](https://docs.spring.io/spring-boot/docs/2.7.18/reference/htmlsingle/index.html#appendix.configuration-metadata.annotation-processor)
